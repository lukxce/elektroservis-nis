        ...
        <div className="relative flex flex-col items-start gap-6 overflow-hidden rounded-3xl bg-gradient-to-br from-navy to-navy-light p-8 text-white sm:flex-row sm:items-center sm:justify-between sm:p-10">
          ...
          <div>
            ...
            <p className="mt-2 max-w-xl text-white/70">
              Pozovite nas i opišite problem. Pomoći ćemo vam da procenimo obim
              posla i dogovorimo izlazak električara.
            </p>
          </div>
          <a
            href={`tel:${phone.replace(/\s/g, "")}`}
            className="shrink-0 rounded-full bg-accent px-6 py-3 text-sm font-semibold text-navy transition hover:bg-accent-dark hover:text-white"
          >
            Pozovite {phone}
          </a>
        </div>
