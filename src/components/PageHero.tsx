  ...
  return (
    <div className="relative hidden h-full w-full items-center justify-center md:flex">
      ...
      <div className="relative flex h-40 w-40 items-center justify-center rounded-[2.5rem] bg-white/10 backdrop-blur">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" className="h-20 w-20 text-accent">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              {primaryCta && (
                <a
                  ...
                  className="rounded-full bg-accent px-6 py-3 text-sm font-semibold text-navy transition hover:bg-accent-dark hover:text-white"
                >
                  {primaryCta.label}
                </a>
              )}
