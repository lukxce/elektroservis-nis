...
export async function CallButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-accent text-navy shadow-lg transition hover:scale-105 hover:bg-accent-dark hover:text-white"
