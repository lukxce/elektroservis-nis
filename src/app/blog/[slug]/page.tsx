      ...
      <Container className="py-14">
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[1fr_320px]">
          <div className="min-w-0 max-w-3xl">
            ...
            {post.category && (
              <span className="mt-4 inline-block rounded-full bg-surface px-3 py-1 text-xs font-semibold uppercase tracking-wide text-accent-dark">
            ...
            <div className="mt-10 rounded-2xl bg-navy p-6 text-white sm:p-8">
              ...
              <a
                ...
                className="mt-4 inline-block rounded-full bg-accent px-6 py-3 text-sm font-semibold text-navy transition hover:bg-accent-dark hover:text-white"
              >
          ...
          <aside className="hidden lg:block">
            <div className="sticky top-24 rounded-2xl border-l-4 border-accent bg-surface p-6">
              ...
              <Link
                href="/kontakt"
                className="mt-4 inline-block rounded-full bg-accent px-5 py-2.5 text-sm font-semibold text-navy transition hover:bg-accent-dark hover:text-white"
              >
                Pošaljite poruku
              </Link>
            </div>
