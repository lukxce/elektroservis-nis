...
export default async function BlogPage() {
  ...
  return (
    <>
      ...
      <PageHero
        eyebrow="Blog"
        title="Korisni tekstovi o električnim instalacijama"
        subtitle="Praktični saveti o bezbednosti, održavanju i renoviranju instalacija. Pišemo ih na osnovu svakodnevnog rada na terenu."
      />
