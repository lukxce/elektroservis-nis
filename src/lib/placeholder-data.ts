...
export const blogPosts: BlogPostItem[] = [
  ...
  },
  {
    ...
    body: [
      ...
      p("Ne mora. Česta i razumna opcija je faznа zamena: prvo tabla i uzemljenje, jer su to stavke koje se tiču bezbednosti cele instalacije, a razvođenje po prostorijama se radi kasnije, prostorija po prostoriju, uporedo sa renoviranjem tog dela stana. Ovo je posebno praktično za porodice koje ne mogu da isele stan na nedelju dana."),
