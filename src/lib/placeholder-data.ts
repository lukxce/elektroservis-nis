...
export const servicePages: ServicePageItem[] = [
  {
    ...
    body: [
      ...
      p("Za sve nove instalacije koristim isključivo bakarne provodnike odgovarajućeg preseka, nikad aluminijumske, bez obzira na to što su nešto jeftiniji. Aluminijum vremenom oksidira na spojevima, kontakt slabi, mesto se zagreva, i to je jedan od najčešćih uzroka starih kvarova na koje nailazim kod instalacija iz osamdesetih i devedesetih godina."),
      h2("Zaštita kao sastavni deo montaže, ne dodatak"),
      p("Svaka nova instalacija koju radim dobija diferencijalnu (FID) zaštitnu sklopku, po mogućstvu odvojenu za svaki veći strujni krug, i odvodnik prenapona u tablu. Ovo nisu stavke koje predlažem kao opciju da bih naplatio više, nego zakonska obaveza i stvar koja doslovno štiti nekog od strujnog udara."),
      h2("Tehnički prijem i dokumentacija"),
      p("Na kraju svake veće montaže radim merenja otpora izolacije i otpora uzemljenja i predajem investitoru zapisnik sa izmerenim vrednostima. Taj papir će vam zatrebati i ako budete kasnije prodavali nekretninu ili sklapali osiguranje."),
    ],
    checklist: [
  ...
  },
  {
    ...
    body: [
      p("Rasveta je deo posla gde greška najbrže postane vidljiva, loše centrirana spot rasveta ili luster koji visi krivo primetiće svako ko uđe u prostoriju. Zato svakoj ugradnji pristupam isto pažljivo, bez obzira da li je u pitanju jedna plafonjera ili kompletan raspored ugradnih svetiljki."),
      h2("Montaža i povezivanje"),
      p("Radim sve vrste unutrašnje i spoljašnje rasvete, od klasičnih plafonjera i lustera do složenijih sistema sa LED trakama, transformatorima i dimer regulacijom. Svaku tačku proveravam pod naponom pre nego što završim posao, uključujući stabilnost nosača kod težih lustera i pravilan polaritet kod LED sistema."),
      h2("Najčešći problemi na koje nailazim"),
      p("Najčešći poziv koji dobijam za rasvetu nije nova ugradnja, nego popravka postojeće, treperenje LED trake obično znači slab ili pogrešan transformator, a zagrevanje oko starih sijaličnih grla je znak da je vreme za zamenu. Kod ugradnje u spušten plafon ili gips-karton uvek prvo proverim raspored nosećih profila da izbegnemo naknadno krpljenje."),
    ],
    checklist: [
  ...
  },
  {
    ...
    body: [
      p("Razvodna tabla je srce svake instalacije, i deo prostora gde najmanje treba štedeti. Stara porcelanska tabla bez zaštitne sklopke je jedan od najčešćih nedostataka koje pronalazim u stanovima i kućama starijim od dvadeset godina."),
      h2("Kad tabla treba zamenu, a kad samo dopunu"),
      p("Ako tabla ima dovoljno mesta za dodatni modul, često je dovoljno samo dodati zaštitnu sklopku ili osigurač za novi krug. Ako je porcelanska, bez mesta za proširenje, ili vidno oštećena, preporučujem kompletnu zamenu modularnom tablom, to je investicija koja se retko ponavlja i direktno utiče na bezbednost cele instalacije."),
      h2("Zaštita koju uvek preporučujem"),
      p("Svaka tabla koju radim dobija diferencijalnu (FID) zaštitnu sklopku i odvodnik prenapona, bez obzira da li je klijent to prvobitno tražio. Ovo nisu opcione stavke, nego osnovna zaštita koja sprečava strujni udar i štiti uređaje od naponskih udara."),
    ],
    checklist: [
  ...
  },
  {
    ...
    body: [
      p("Utičnice i prekidači deluju kao najjednostavniji deo instalacije, ali baš tu najčešće nailazim na improvizacije, utičnica bez uzemljenja u kuhinji, prekidač na pogrešnom mestu posle renoviranja, ili nedovoljno utičnica za savremenu upotrebu prostora."),
      h2("Kad je dovoljna zamena, a kad nova tačka"),
      p("Ako postojeća instalacija ima dovoljno kapaciteta, zamena stare utičnice ili dodavanje nove na blizak vod je brza intervencija u jednoj poseti. Za prostorije sa jačim trošilima, poput kuhinje ili radionice, često je bolje rešenje posebna linija sa sopstvenim osiguračem, umesto dodavanja na već opterećen krug."),
      h2("Posebna pažnja za kupatilo i spoljne prostore"),
      p("Kupatila i terase zahtevaju vodootporne utičnice odgovarajuće IP zaštite i pravilnu udaljenost od izvora vode, ovo nije mesto za kompromis. Isto pravilo važi i za spoljne utičnice u dvorištu, gde loše urađena zaštita od vlage brzo dovodi do kvara."),
    ],
    checklist: [
  ...
  },
  {
    ...
    body: [
      p("Veliki deo poziva koje dobijam nema veze sa zidnom instalacijom, nego sa kućnim uređajima koji su prestali da rade ili rade neispravno. Bojler koji ne greje, šporet kod kojeg radi samo jedna ringla, veš mašina koja ne startuje, sve su to kvarovi koje redovno rešavam na terenu."),
      h2("Šta najčešće popravljam"),
      p("Najčešći pozivi su za servis bojlera (zamena grejača ili termostata), popravku električnog šporeta i dijagnostiku veš mašina koje ne uključuju program. Kod većine ovih uređaja kvar je moguće locirati i otkloniti na licu mesta, bez odnošenja u servis, osim kod ozbiljnijih oštećenja elektronike."),
      h2("Kad se popravka ne isplati"),
      p("Iskreno kažem klijentu kad popravka više nema smisla, na primer kod starijeg bojlera gde bi zamena rezervoara koštala skoro koliko i nov uređaj. Cilj mi je da vam uštedim novac, ne da naplatim svaku moguću intervenciju."),
    ],
    checklist: [
  ...
  },
  {
    ...
    body: [
      p("Ugradnja klime nije samo mehanički posao okačiti unutrašnju i spoljnu jedinicu, elektro deo, poseban osigurač i pravilno uzemljen priključak su podjednako važni, i baš tu najčešće viđam propuste kod jeftinijih, brzih montaža."),
      h2("Kako radim montažu"),
      p("Svaka klima dobija sopstvenu liniju sa odgovarajućim osiguračem direktno do razvodnog ormana, bez deljenja voda sa drugim trošilima. Pozicioniranje spoljne jedinice biram tako da bude dostupna za budući servis, a ne samo estetski najlepša."),
      h2("Servis i održavanje"),
      p("Redovno čišćenje filtera i spoljne jedinice produžava vek klime i smanjuje potrošnju struje, preporučujem servis bar jednom godišnje, idealno pre početka sezone. Dopunu freona radim samo kad merenje pokaže da je stvarno potrebna, ne kao automatsku stavku uz svaki servis."),
    ],
    checklist: [
  ...
  },
  {
    ...
    body: [
      p("Punjač za električni automobil troši znatno više struje od bilo kog drugog kućnog uređaja, i to je prvo što proveravam pre ugradnje, da li postojeća instalacija i priključna snaga objekta uopšte mogu da podnesu dodatno opterećenje."),
      h2("Šta proveravam pre ugradnje"),
      p("Pre montaže punjača, proveravam ukupnu priključnu snagu objekta i trenutnu opterećenost razvodnog ormana. Ako postojeći priključak nije dovoljan, predlažem realne opcije, od punjenja manjom snagom do razgovora sa distributerom o povećanju priključne snage."),
      h2("Kako izgleda sama ugradnja"),
      p("Punjač dobija sopstvenu liniju odgovarajućeg preseka, poseban osigurač i, po potrebi, zaštitnu sklopku prilagođenu tipu punjenja. Trasu i poziciju biramo tako da bude praktična za svakodnevno korišćenje, u garaži ili na prilazu kući."),
    ],
    checklist: [
