...
export const blogPosts: BlogPostItem[] = [
  ...
  {
    slug: "5-znakova-da-vam-treba-nova-elektro-instalacija",
    title: "5 znakova da vam treba nova elektro instalacija",
    category: "bezbednost",
    excerpt:
      "Starija instalacija ne mora da izazove kvar da bi bila opasna. Evo pet znakova koji jasno govore da je vreme za zamenu, ne za krpljenje.",
    summary:
      "Pet najčešćih znakova da elektroinstalacija u stanu ili kući zahteva zamenu, ne samo popravku: treperenje svetla pod opterećenjem, tople utičnice ili prekidači, česti ispadi osigurača, aluminijumske žice iz sedamdesetih i osamdesetih, i odsustvo zaštitnog uzemljenja. U Nišu, gde je znatan deo stambenog fonda star trideset i više godina, ovi znakovi su češći nego što vlasnici pretpostavljaju.",
    keyTakeaways: [
      "Treperenje svetla kad uključite veći uređaj znači da je instalacija preopterećena ili oštećena",
      "Topla utičnica ili prekidač je ozbiljan signal koji ne sme da se ignoriše",
      "Česti ispadi osigurača su zaštitni mehanizam koji radi svoj posao, ne smetnja koju treba zaobići",
      "Aluminijumske žice iz perioda pre devedesetih su najčešći skriveni rizik u starijim niškim zgradama",
    ],
    publishedAt: "2026-07-30T09:00:00.000Z",
    body: [
      p("Elektroinstalacija u prosečnom stanu u Nišu često je starija od trideset godina, ponekad i četrdeset. To ne znači automatski da je opasna, ali znači da je projektovana za potpuno drugačije opterećenje od današnjeg. Stan iz osamdesetih nije predvidio klima uređaj, električnu ploču za kuvanje, veš mašinu, sušilicu i punjač za automobil na istoj instalaciji. Pet znakova ispod govore da instalacija više ne drži korak sa onim što od nje tražite."),
      h2("1. Treperenje svetla kad uključite veći uređaj"),
      p("Ako svetlo u sobi zatreperi ili privremeno potamni kad uključite bojler, veš mašinu ili klimu, to znači da linija na kojoj je uređaj ne može da podnese nagli skok struje bez posledica po ostatak instalacije. U ispravno dimenzionisanoj instalaciji, veći uređaj ima sopstveni strujni krug i ne utiče na ostatak stana."),
      p("Treperenje jednom nije razlog za paniku, ali ako se ponavlja pri svakom uključivanju, vreme je da se proveri presek kabla na toj liniji i opterećenje na osiguračima. Često se ispostavi da dva ili tri velika uređaja dele isti strujni krug koji je predviđen za sijalice i poneku utičnicu."),
      h2("2. Tople utičnice ili prekidači"),
      p("Utičnica ili prekidač koji su topli na dodir, a pogotovo vrući ili potamnjeni oko sebe, su signal koji ne sme da se ignoriše. Toplota nastaje od lošeg kontakta unutar utičnice ili prekidača, gde struja prelazi kroz umanjen ili oštećen kontakt i pretvara razliku u toplotu. To je put ka pregrevanju i, u krajnjem slučaju, požaru."),
      p("Ono što vlasnici često rade je da izvuku uređaj iz te utičnice i nastave da koriste drugu. To rešava simptom, ali ne problem, jer je loš kontakt i dalje tu i može se pogoršati. Ispravna reakcija je zamena utičnice i provera žice koja do nje vodi."),
      h2("3. Česti ispadi osigurača"),
      p("Osigurač koji redovno iskače nije pokvaren. On radi upravo ono za šta je projektovan, isključuje struju kad opterećenje premaši bezbednu granicu. Problem je u onome što ga tera da reaguje: previše uređaja na jednom strujnom krugu, loša izolacija kabla koja izaziva kratke spojeve, ili uređaj koji vuče previše struje."),
      p("Najgora moguća reakcija je zamena osigurača jačim, što je praksa koja se u starijim zgradama u Nišu i dalje sreće. Osigurač od 16 ampera koji stalno iskače ne treba zameniti osiguračem od 25 ampera, jer time uklanjate jedinu zaštitu koju instalacija ima od pregrevanja kabla koji je dimenzionisan za 16 ampera. Rezultat nije stabilnija struja, nego instalacija koja se greje bez upozorenja."),
      h2("4. Aluminijumske žice"),
      p("Instalacije rađene u sedamdesetim i osamdesetim godinama u Srbiji često koriste aluminijumske provodnike umesto bakarnih. Aluminijum je u to vreme bio jeftiniji, ali ima osobine koje ga čine lošijim izborom za dugotrajnu kućnu instalaciju: brže se umara na savijanjima, oksidira na spojevima (što stvara otpor i toplotu), i ekspandira i kontrahuje se pod opterećenjem više nego bakar, što vremenom razlabavi kontakte u utičnicama."),
      p("Aluminijumska žica sama po sebi nije ilegalna i nije svaki stan sa njom u neposrednoj opasnosti. Ali je to instalacija kojoj je istekao razuman vek trajanja i koja zahteva znatno pažljiviju proveru nego bakarna instalacija istih godina. Ako vam je stan iz tog perioda i niste sigurni koji je materijal, pozovite nas da izmerimo stanje, intervencija nije nužno hitna, ali saznanje kakvo je stanje je besplatno na terenu."),
      h2("5. Odsustvo uzemljenja"),
      p("Uzemljenje je zaštita koja u slučaju kvara izolacije na nekom uređaju odvodi struju u zemlju umesto kroz vaše telo. Stanovi građeni pre devedesetih često nemaju zaštitno uzemljenje uopšte, ili ga imaju samo formalno, sa žicom koja ni do čega ne vodi. Bez uzemljenja, FID (diferencijalna) sklopka ne može pouzdano da reaguje, a metalna kućišta bojlera, veš mašine i šporeta postaju rizik pri kvaru."),
      p("Izrada uzemljenja u već useljenom stanu izgleda kao veliki posao, i jeste u pogledu značaja, ali tehnički je izvodljivo bez rušenja zidova u većini slučajeva. Posebno je važno u prizemnim kućama u Nišu, gde je uzemljivač najčešće bakarni štap ukopan pored temelja, a veza od njega do table je ono što se proverava i, po potrebi, zamenjuje ili dodaje."),
      h2("Šta uraditi ako prepoznajete jedan ili više znakova"),
      p("Nijedan od ovih znakova ne zahteva da tog trenutka isključite struju i napustite stan. Ali svaki od njih zahteva da ih ne ignorišete sezonama i godinama, jer se stanje ne popravlja samo, nego se polako pogoršava. Pozovite nas za merenje stanja instalacije, proveru izolacije i pregled razvodne table. Na osnovu toga kažemo tačno šta treba, koliko košta i koliko je hitno, bez nepotrebnog dramatizovanja i bez neiskrenog umanjivanja stvarnog stanja."),
    ],
    faq: [
      { question: "Da li je svako treperenje svetla znak za uzbunu?", answer: "Ne svako, ali ako se ponavlja pri svakom uključivanju većeg uređaja, to znači da linija ne drži opterećenje i treba proveriti presek kabla i raspored osigurača." },
      { question: "Koliko košta zamena cele instalacije u stanu?", answer: "Kompletna nova instalacija za stan u Nišu kreće se od 1900 do 2600 dinara po kvadratnom metru, u zavisnosti od broja tačaka i složenosti razvoda. Tačnu cenu dajemo posle obilaska jer svaki stan ima drugačiju situaciju." },
      { question: "Da li mogu da sačekam renoviranje da zamenim instalaciju?", answer: "Idealno da. Zamena instalacije je najlogičnija uz renoviranje jer se zidovi svejedno otvaraju. Ali ako imate neke od ozbiljnijih znakova, tople utičnice ili česte ispade, ne treba čekati renoviranje, nego bar utvrditi stanje i po potrebi uraditi hitne popravke." },
      { question: "Kako znam da li imam aluminijumsku ili bakarnu instalaciju?", answer: "Najlakše je skinuti jednu utičnicu i pogledati boju žice na krajevima: bakar je karakteristične crvenkaste boje, aluminijum je sivobeličast. Ako niste sigurni ili ne želite da dirate utičnicu sami, izađemo i proverimo bez naplate." },
      { question: "Da li je zamena instalacije moguća bez rušenja zidova?", answer: "Delimično da. Novi kablovi se mogu provući kroz postojeće kanale ili u spoljnim PVC kanalicama, ali za potpuno novu instalaciju sa novim žlebovima, malteriski radovi su neizbežni. O tome razgovaramo na obilasku, jer zavisi od konkretnog stana." },
    ],
  },
];
