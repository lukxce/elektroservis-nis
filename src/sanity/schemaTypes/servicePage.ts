...
export const servicePage = defineType({
  ...
  fields: [
    defineField({
      ...
      title: 'Naslov',
      type: 'string',
      description: 'npr. "Montaža električnih instalacija"',
    ...
    defineField({
      ...
      type: 'string',
      description: 'Naslov za H1 na stranici, sa gradom, npr. "Električar u Nišu". Ako je prazno, koristi se obični naslov.',
    }),
    defineField({
      name: 'heroSubtitle',
    ...
    defineField({
      ...
      type: 'string',
      description: 'npr. "Hitne intervencije 0-24"',
    }),
    defineField({
      name: 'ctaBandText',
